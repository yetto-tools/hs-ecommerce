    ...
    <Fragment>
      ...
      <LayoutOne headerTop="visible">
        ...
        <Breadcrumb
          pages={[
            {
              label: t("page_not_found.label_home")
                ? t("page_not_found.label_home")
                : "Home",
              path: process.env.PUBLIC_URL + "/",
            },
            {
              label: t("page_not_found.label_404_page")
                ? t("page_not_found.label_404_page")
                : "404 page",
              ...
              <div className="col-xl-7 col-lg-8 text-center">
                <div className="error">
                  ...
                  >
                    ...
                    <button
                      type="submit"
                      className="searchform__submit text-white fw-bold"
                    >
