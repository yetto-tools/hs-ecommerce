...
import { fetchArticles, fetchFilterAritcle } from "../../hooks/use-FetchArticles";
...
const ShopSidebarFilters = ({ filters, sideSpaceClass }) => {
  ...
  const selected = (filterType, value) =>{
    return Array.isArray(activeFilters[filterType]) && activeFilters[filterType].includes(value);
  ...
  return (
    <div className={clsx("sidebar-style mt-4", "pr-20", sideSpaceClass)}>
      {/* Buscador */}
      <ShopSearch />
      <div className="my-5 d-flex flex-row align-items-center justify-content-start">
      ...
      <div className="sidebar-widget">
        ...
        <div className="sidebar-widget-list mt-30">
          <ul>
            <li className={clsx({ "active-filter": isActive("Marca", "todo") })}>
